 ...
 * Cliente.java
 *
 * Created on 21/04/2010, 01:24:48
 */
...
public class RelCliente extends javax.swing.JFrame {
   ...
   ////// CLIENTES //////
    ...
    public void carregarTabela()
    {
        try {
            ...
            List<Cliente> lista = (List<Cliente>) cli.lista();
            ...
            for (Cliente c : lista) {
                modelo.addRow(new Object[]{
                    ...
                    c.getNome(),
                    c.getCpf(),
                    formatador.format(c.getDataCadastro())
                });
            }
    ...
    private String formatar(String s, String m) throws ParseException
    {
        MaskFormatter f = new MaskFormatter(m);

        return f.valueToString(s);
    }
    ...
    private void abreFormularioEdicao()
    {
            ...
            ec.setIdCliente(Integer.parseInt(String.valueOf(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 0))));
            ec.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.JPopupMenu menuPopUpClientes = new javax.swing.JPopupMenu();
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/group.png"))); // NOI18N
        ...
        menuPopUpClientes.add(jMenuItem3);
        menuPopUpClientes.add(jSeparator1);
        ...
        menuPopUpClientes.add(jMenuItem1);

        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/group_delete.png"))); // NOI18N
        ...
        menuPopUpClientes.add(jMenuItem2);

        setTitle("Locaki ~ A Sua Locadora! : Relação de Clientes");
        setAlwaysOnTop(true);
        setResizable(false);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(txtBusca, javax.swing.GroupLayout.DEFAULT_SIZE, 382, Short.MAX_VALUE)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Relação de Clientes:"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            List<Cliente> lista = (List<Cliente>) cli.buscar(txtBusca.getText());
    ...
    private void tabelaClienteselecionaRegistro(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClienteselecionaRegistro
        if (evt.getClickCount() == 2)
           this.abreFormularioEdicao();
}//GEN-LAST:event_tabelaClienteselecionaRegistro
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir este cliente?", "Locaki ~ A Sua Locadora!", 2, 2) == 0) {
            try {
                ...
                cad.excluir(Integer.parseInt(String.valueOf(tabelaCliente.getValueAt(tabelaCliente.getSelectedRow(), 0))));
    ...
    */
    ...
    javax.swing.JTable tabelaCliente;
