 ...
 * Locacoes.java
 *
 * Created on 21/04/2010, 01:25:30
 */
 ...
 * @author Tiago
 */
public class RelLocacao extends javax.swing.JFrame {
   ...
   ////// CLIENTES //////
    ...
    {
            VerLocacao l = new VerLocacao();
            l.getDados(Integer.parseInt(String.valueOf(tabelaLocacao.getValueAt(tabelaLocacao.getSelectedRow(), 0))));
            l.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        javax.swing.JPopupMenu menuPopUpLocacoes = new javax.swing.JPopupMenu();
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/report_go.png"))); // NOI18N
        jMenuItem3.setText("Visualizar Locação");
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem3ActionPerformed(evt);
            }
        });
        menuPopUpLocacoes.add(jMenuItem3);
        menuPopUpLocacoes.add(jSeparator5);

        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/report_delete.png"))); // NOI18N
        jMenuItem2.setText("Excluir Locação");
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem2ActionPerformed(evt);
            }
        });
        menuPopUpLocacoes.add(jMenuItem2);

        setTitle("Locaki ~ A Sua Locadora! : Relação de Locações");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Buscar Locação:"));

        jLabel1.setText("Cliente/Filme:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(txtBusca, javax.swing.GroupLayout.DEFAULT_SIZE, 372, Short.MAX_VALUE)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Relação de Locações:"));
        ...
        tabelaLocacao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código:", "Cliente:", "Valor Locação:", "Data Cadastro:"
            }
        ) {
        ...
        tabelaLocacao.setComponentPopupMenu(menuPopUpLocacoes);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            List<Locacao> lista = (List<Locacao>) lCrud.buscar(txtBusca.getText().toUpperCase());
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir esta locação?", "Locaki ~ A Sua Locadora!", 2, 2) == 0) {
            try {
                ...
                lCrud.excluir(Integer.parseInt(String.valueOf(tabelaLocacao.getValueAt(tabelaLocacao.getSelectedRow(), 0))));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelLocacao().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    javax.swing.JTable tabelaLocacao;
