 ...
 * Dicas.java
 *
 * Created on 13/05/2010, 20:29:14
 */
...
public class Dicas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Duplo clique sobre a dica para visualizá-la");
    ...
    private void carregarTabela()
    {
        try
        {
            DicasCRUD dic = new DicasCRUD();

            List<Dicas> lista = (List<Dicas>) dic.listar();
      ...
      private void abreDescricaoDicas()
    {
            DescDicas DDicas = new DescDicas();
            DDicas.setVisible(true);
    }
