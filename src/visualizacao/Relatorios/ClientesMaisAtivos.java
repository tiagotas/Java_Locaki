...
/*
 * ClientesMaisAtivos.java
 *
 * Created on 13/05/2010, 20:24:57
 */
 ...
 * @author Tiago
 */
public class ClientesMaisAtivos extends javax.swing.JFrame {
    ...
    /** Creates new form ClientesMaisAtivos */
    public ClientesMaisAtivos() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getClientesMaisAtivos(jTextField1.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Clientes Mais Ativos ");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Clientes Mais Ativos:"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesMaisAtivos().setVisible(true);
            }
        });
    }
