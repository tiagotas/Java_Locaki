 ...
 * FilmesTopDez.java
 *
 * Created on 13/05/2010, 20:25:58
 */
 ...
 * @author Tiago
 */
public class FilmesTopDez extends javax.swing.JFrame {
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getFilmesTopDez();

            DefaultTableModel modelo = (DefaultTableModel) topDez.getModel();
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório do Top 10 do Mês");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Top Dez Filmes:"));

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Periodo:"));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Mês: Julho ");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Ano: 2010");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Filmes:"));

        topDez.setAutoCreateRowSorter(true);
        topDez.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código:", "Título:", "Número de Locações:", "Receita Gerada:"
            }
        ) {
        ...
        topDez.setRequestFocusEnabled(false);
        topDez.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        topDez.getTableHeader().setResizingAllowed(false);
        jScrollPane2.setViewportView(topDez);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FilmesTopDez().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    javax.swing.JTable topDez;
