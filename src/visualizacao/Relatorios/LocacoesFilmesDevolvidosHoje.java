...
/*
 * LocacoesFilmesDevolvidosHoje.java
 *
 * Created on 13/05/2010, 20:26:33
 */
 ...
 * @author Tiago
 */
public class LocacoesFilmesDevolvidosHoje extends javax.swing.JFrame {
    ...
    /** Creates new form LocacoesFilmesDevolvidosHoje */
    public LocacoesFilmesDevolvidosHoje() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getLocacoesDevolvidosHoje(jTextField1.getText().toUpperCase());
            ...
            for (RelatoriosGerais r : lista) {
                modelo.addRow(new Object[]{
                            r.getIdFilme(),
                            r.getFilme(),
                            formatador.format(r.getDataDevolucaoReal())
                        });
            }
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Filmes Devolvidos Hoje ");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Filmes Devolvidos Hoje:"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocacoesFilmesDevolvidosHoje().setVisible(true);
            }
        });
    }
