...
/*
 * ClientesMenosAtivos.java
 *
 * Created on 13/05/2010, 20:25:13
 */
 ...
 * @author Tiago
 */
public class ClientesMenosAtivos extends javax.swing.JFrame {
    ...
    /** Creates new form ClientesMenosAtivos */
    public ClientesMenosAtivos() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getClientesMenosAtivos(jTextField1.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Clientes Menos Ativos");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("ClientesMenos Ativos:"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código:", "Nome:", "Número de Locações:", "Última Locação:"
            }
        ) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesMenosAtivos().setVisible(true);
            }
        });
    }
