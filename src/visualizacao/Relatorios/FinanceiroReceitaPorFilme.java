...
/*
 * FinanceiroReceitaPorFilme.java
 *
 * Created on 13/05/2010, 20:27:30
 */
 ...
 * @author Tiago
 */
public class FinanceiroReceitaPorFilme extends javax.swing.JFrame {
    ...
    /** Creates new form FinanceiroReceitaPorFilme */
    public FinanceiroReceitaPorFilme() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getReceitaPorFilme(jTextField1.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Receita por Filme");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Receita Por Filme:"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código:", "Título:", "Número de Locações:", "Receita:"
            }
        ) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinanceiroReceitaPorFilme().setVisible(true);
            }
        });
    }
