...
/*
 * LocacoesTotalLocacoesMes.java
 *
 * Created on 13/05/2010, 20:27:05
 */
 ...
 * @author Tiago
 */
public class LocacoesTotalLocacoesMes extends javax.swing.JFrame {
    ...
    /** Creates new form LocacoesTotalLocacoesMes */
    public LocacoesTotalLocacoesMes() {
        initComponents();
    ...
    private void carregarDados()
    {
        try
        {
            ...
            RelatoriosGerais r = rCrud.getTotalLocacoesMes();
            
            DecimalFormat df = new DecimalFormat("#,###0.00");
            //SimpleDateFormat formatador = new SimpleDateFormat("dd/MM/yyyy - HH:mm");

            jLabel3.setText(String.valueOf(r.getTotalLocacoes()));
            jLabel4.setText("R$ " + String.valueOf(df.format(r.getReceita())));
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório Total de Locações no Mês");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Total de Locações:"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Número de Locações:"));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("Receita do Periodo:"));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("R$ 357,00");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Dias Corridos:"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocacoesTotalLocacoesMes().setVisible(true);
            }
        });
    }
