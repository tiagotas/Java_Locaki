...
/*
 * FilmesMenosProcurados.java
 *
 * Created on 13/05/2010, 20:25:43
 */
 ...
 * @author Tiago
 */
public class FilmesMenosProcurados extends javax.swing.JFrame {
    ...
    /** Creates new form FilmesMenosProcurados */
    public FilmesMenosProcurados() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getFilmesMenosProcurados(jTextField1.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Filmes Menos Procurados");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Filmes Menos Procurados:"));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código:", "Título:", "Número de Locações:", "Última Locação:"
            }
        ) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FilmesMenosProcurados().setVisible(true);
            }
        });
    }
