...
/*
 * FilmesMaisProcurados.java
 *
 * Created on 13/05/2010, 20:25:28
 */
 ...
 * @author Tiago
 */
public class FilmesMaisProcurados extends javax.swing.JFrame {
    ...
    /** Creates new form FilmesMaisProcurados */
    public FilmesMaisProcurados() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getFilmesMaisProcurados(jTextField1.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Filmes Mais Procurados");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Filmes Mais Procurados:"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FilmesMaisProcurados().setVisible(true);
            }
        });
    }
