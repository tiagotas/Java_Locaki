...
/*
 * FinanceiroReceitaPorPeriodo.java
 *
 * Created on 13/05/2010, 20:28:22
 */
 ...
 * @author Tiago
 */
public class FinanceiroReceitaPorPeriodo extends javax.swing.JFrame {
    ...
    /** Creates new form FinanceiroReceitaPorPeriodo */
    public FinanceiroReceitaPorPeriodo() {
        initComponents();
    ...
    private void carregarTabela()
    {
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getReceitaPorPeriodo(null, null);
            ...
            for (RelatoriosGerais r : lista) {
                modelo.addRow(new Object[]{
                            formatador.format(r.getPeriodo()),
        ...
        {
             JOptionPane.showMessageDialog(this, "Desculpe, ocorreu um erro: \n "  + ec.getMessage(), "Locaki ~ A Sua Locadora!", 0);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Locaki ~ A Sua Locadora! : Relatório de Receita por Período");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Receita Por Periodo:"));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(dataInicial, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(dataFinal, javax.swing.GroupLayout.PREFERRED_SIZE, 192, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data:", "Receita:", "Número de Locações:"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            List<RelatoriosGerais> lista = (List<RelatoriosGerais>) rCrud.getReceitaPorPeriodo(new java.sql.Date( ((java.util.Date)formatador.parse(dataInicial.getText())).getTime()), new java.sql.Date( ((java.util.Date)formatador.parse(dataFinal.getText())).getTime()));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinanceiroReceitaPorPeriodo().setVisible(true);
            }
        });
    }
