 ...
 * verLocacao.java
 *
 * Created on 10/06/2010, 20:34:33
 */
 ...
 * @author Tiago
 */
public class VerLocacao extends javax.swing.JFrame {
   ...
   ////// CLIENTES //////
    ...
    public void getDados(int id)
    {
        try
        {
           ...
           Locacao l = lCrud.getRegistro(id);

           codigo.setText(String.valueOf(l.getIdLocacao()));

           dataLocacao.setValue(l.getDataLocacao());
           dataDevolucaoEstimada.setValue(l.getDataDevolucaoEstimada());
           dataDevolucaoReal.setValue(l.getDataDevolucaoReal());


           if(dataDevolucaoReal.getText().equals(""))
           {
               status.setText("PENDENTE!");
               status.setFont(new java.awt.Font("Tahoma", 1, 14));
               status.setForeground(new java.awt.Color(204, 0, 0));
           } else {
               status.setText("DEVOLVIDA!");
               status.setFont(new java.awt.Font("Tahoma", 1, 14));
               status.setForeground(new java.awt.Color(0, 153, 0));
           }

           cliente.setText(l.getCliente());
           promocao.setText(l.getPromocao());

           valorLocacao.setText("R$ " + df.format(l.getValorLocacao()));

           this.carregarFilmesLocacao(id);
           this.setarEnableBntBaixar();
    ...
    public void carregarFilmesLocacao(int idLocacao)
    {
        try {
            LocacaoCRUD lCrud = new LocacaoCRUD();

            List<Filme> lista = (List<Filme>) lCrud.itensLocacao(idLocacao);
    ...
    public void setarEnableBntBaixar()
    {
        if(!dataDevolucaoReal.getText().equals(""))
    ...
    private void initComponents() {
        ...
        dataDevolucaoEstimada = new javax.swing.JFormattedTextField();
        javax.swing.JLabel jLabel4 = new javax.swing.JLabel();
        dataDevolucaoReal = new javax.swing.JFormattedTextField();
        ...
        bntBaixar = new javax.swing.JButton();
        javax.swing.JButton jButton2 = new javax.swing.JButton();
        valorLocacao = new javax.swing.JLabel();
        ...
        setTitle("Locaki ~ A Sua Locadora! : Visualiando Locação");
        setAlwaysOnTop(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Locação Lançada:"));
        ...
        dataLocacao.setEditable(false);
        dataLocacao.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("dd/MM/yyyy - HH:mm"))));

        jLabel3.setText("Data Devolução:");

        dataDevolucaoEstimada.setEditable(false);
        dataDevolucaoEstimada.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter()));

        jLabel4.setText("Data Devolução Real:");

        dataDevolucaoReal.setEditable(false);
        dataDevolucaoReal.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("dd/MM/yyyy - HH:mm"))));

        jLabel5.setText("Cliente:");

        jLabel6.setText("Promoção:");

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Filmes Locados:"));
        ...
        tabelaItens.setRequestFocusEnabled(false);
        ...
        bntBaixar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/report_go.png"))); // NOI18N
        bntBaixar.setText("Baixar Locação!");
        bntBaixar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bntBaixarActionPerformed(evt);
            }
        });

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visualizacao/Icones/report_delete.png"))); // NOI18N
        ...
        valorLocacao.setFont(new java.awt.Font("Tahoma", 1, 14));
        valorLocacao.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        valorLocacao.setText("R$ 0,00");
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(dataDevolucaoEstimada, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addComponent(jLabel5))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel6)
                            .addComponent(promocao, javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(dataDevolucaoReal, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(24, 24, 24))
                                    .addComponent(status, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(valorLocacao, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 80, Short.MAX_VALUE)
                        .addComponent(jButton3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(bntBaixar)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(dataDevolucaoReal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(status, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(dataDevolucaoEstimada, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(jLabel6)))
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(valorLocacao, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(bntBaixar)
                        .addComponent(jButton2)
                        .addComponent(jButton3))))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "Tem certeza que deseja excluir esta locação?", "Locaki ~ A Sua Locadora!", 2, 2) == 0) {
            try {
                LocacaoCRUD lCrud = new LocacaoCRUD();

                lCrud.excluir(Integer.parseInt(String.valueOf(tabelaItens.getValueAt(tabelaItens.getSelectedRow(), 0))));

                JOptionPane.showMessageDialog(this, "Locação Excluída com Sucesso!", "Locaki ~ A Sua Locadora!", 1);
    ...
    private void bntBaixarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntBaixarActionPerformed
        // TODO add your handling code here:

        try {
            LocacaoCRUD lCrud = new LocacaoCRUD();

            lCrud.baixar(Integer.parseInt(codigo.getText()));

            JOptionPane.showMessageDialog(this, "Locação Baixada com Sucesso!", "Locaki ~ A Sua Locadora!", 1);
    ...
    }//GEN-LAST:event_bntBaixarActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerLocacao().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton bntBaixar;
    javax.swing.JTextField cliente;
    javax.swing.JTextField codigo;
    javax.swing.JFormattedTextField dataDevolucaoEstimada;
    javax.swing.JFormattedTextField dataDevolucaoReal;
    javax.swing.JFormattedTextField dataLocacao;
    javax.swing.JTextField promocao;
    javax.swing.JTextField status;
    javax.swing.JTable tabelaItens;
    javax.swing.JLabel valorLocacao;
